...
case object InvLap extends WhichKernel {
  override val name: String = "InvLap"
}
case object InvLapDot extends WhichKernel {
  override val name: String = "InvLapDot"
}
case object Gauss extends WhichKernel {
  override val name: String = "Gauss"
}
case object GaussMirror extends WhichKernel {
